function [ classes, labels ] = predict_SVM(SVMModels, path_to_images, amount_test_images, nr_clusters, kmeans_clusters, method, sift_method)
    ...
    [labels_cars, scores_cars] = predict(SVMModels{2}, data);
    [labels_faces, scores_faces] = predict(SVMModels{3}, data);
    [labels_motorbikes, scores_motorbikes] = predict(SVMModels{4}, data);
